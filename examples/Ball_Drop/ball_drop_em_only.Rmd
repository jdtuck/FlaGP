...
flagp.data = flagp(X.sim = X.sim, Y.sim = Y.sim, y.ind.sim = y.ind.sim, n.pc = 2,
                  center = T, scale = T, scaletype = 'rowwise', 
                  ls.subsample = T, ls.m = 25,ls.K = 3, # set m & K for fast lengthscale estimation
                  verbose=T) 
```
